<?php include 'includes/header.php';?>
       <main>
          ...
          <p id="bottom">Outside of school, I enjoy running, traveling, watching documentaries, listening to podcasts, and spending
              time with my cat, Moose.</p> 
          </div><!--END text-contain-->   
      </main>

        <aside>
          <img class="desktop" src="images/snowy-trees.jpg" alt="Snowy pine trees" />
          <img class="tablet" src="images/vertical-pic.jpg" alt="Arial view of foggy mountains" />
